      ...
      <div className={space('space-y-10')}>
        <CardSection>
          ...
          <CardParagraph>
            ...
            want. We do not store your data on our servers, and our repositories
            are fully public (
            <LinkText url="https://github.com/BigWhaleLabs">See here</LinkText>
        ...
        <CardSection>
          <CardSubheder>What are ZK Badges?</CardSubheder>
          <CardParagraph>
            ZK Badges are minted when you create ‘ZK Proof’ using an NFT, asset,
            or piece of your identity. This is all done using a mix of ZK proof,
            EdDSA, and the blockchain. That allows us to create pseudonymous
            accounts on the blockcahin. We also wrote about what we’ve done so
            far on our blog
            <LinkText url="https://blog.bigwhalelabs.com">here</LinkText>.
          </CardParagraph>
          <CardParagraph>
            Essentially, we use cryptography to keep your identity anonymous and
            verified at the same time.
          </CardParagraph>
        </CardSection>
        <CardSection>
          <CardSubheder>How can emails be anonymous?</CardSubheder>
          <CardParagraph>
            In this case, when you present us with your work email we send you a
            token. If you have access to that email, you can access that token.
            Then, you can use that token to create ZK Proof with SealCred (
